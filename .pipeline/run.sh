...
# All seven live outside this script so they can be unit-tested offline
...
for lib in backlog verdict health pipeline_health preflight postcondition schedule; do

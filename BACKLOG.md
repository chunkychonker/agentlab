...
- [ ] fix (health 2026-09-13): BACKLOG.md:216 is still marked [building] ("fix (health 2026-09-02): BACKLOG.md:24 ... never advanced to [done #37]") but the work shipped and merged as PR #42 (cycle/2026-09-10-backlog-mark-done-reconcile, merged 2026-09-10) and its subject BACKLOG.md:24 now reads [done #37] — the line should read [done #42]. The reconcile helper that would have caught this shipped inside PR #42 itself, so it could not reconcile its own cycle, and later cycles only reconcile their own claim...
